...
//   present_value: z.coerce.number(),
//   future_value: z.coerce.number(),
//   fee: z.coerce.number(),
//   contribution: z.coerce.number().optional(),
// })

// type CalcPeriodSchema = z.infer<typeof CalcPeriodSchema>

// export function CalcForm({ ...props }: CalcFormProps) {
//   const { handleSubmit, register } = useForm({ resolver: zodResolver(CalcPeriodSchema) })
